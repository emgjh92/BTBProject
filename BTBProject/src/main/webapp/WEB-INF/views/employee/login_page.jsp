...
<script type="text/javascript">
   ...
   function admin_form(i) {
         
      var frm = document.getElementById("frm");
      var emp_no;
      var emp_password='1111';
      if(i==1){
      emp_no= '202010001';
      }
      else if(i==2){
         ...
         xmlhttp.onreadystatechange = function() {
            ...
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
               ...
               if (xmlhttp.responseText == 'true') {
                  ...
                  document.getElementById("emp_password").value=emp_password;
            ...
            <div class="row mr-5 mt-5 rounded shadow"
               ...
               <div class="col-6">
                  ...
                  <div class="row mt-2">
                     ...
                     <button type="button" class="btn btn-secondary btn-block dropdown-toggle" data-toggle="dropdown">관리자 로그인</button>
                     <div class="dropdown-menu text-center" >
                        <a class="dropdown-item" style="width:430px;" href="javascript:admin_form(1);">관리부 로그인</a>
                        <a class="dropdown-item" href="javascript:admin_form(2);">영업부 로그인</a>
                        <a class="dropdown-item" href="javascript:admin_form(3);">물류부 로그인</a>
                        <a class="dropdown-item" href="javascript:admin_form(4);">생산부 로그인</a>
                     </div>
                     </div>
                  </div>
               </div>
